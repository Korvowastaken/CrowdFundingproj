...
import EnhancedScrollAnimations, { StaggeredAnimation, ParallaxElement, FloatingElement } from '../components/EnhancedScrollAnimations'
  ...
  return (
    <div className='bg-gray-100 overflow-x-hidden'>
      ...
      <div ref={page1Ref} className="min-h-screen relative">
        {/* Enhanced Navigation */}
        <EnhancedScrollAnimations animationType="slideDown" duration={800}>
          <nav className='w-full h-24 fixed top-0 left-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-200'>
            <div className='flex w-full h-24 px-8'>
              <div className='w-1/6 h-full flex justify-center items-center'>
                <div className='bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl px-6 py-3 shadow-xl hover-lift'>
              ...
              <div className='w-1/6 h-full flex justify-center items-center space-x-4'>
                <div className='w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-700 transition-colors duration-200 hover-lift'>
                ...
                <div className="relative">
                  <button 
                    ...
                    className='w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-700 transition-colors duration-200 hover-lift'
                  >
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {showDropdown && (
                    <div className="absolute right-0 mt-3 w-56 bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl z-10 border border-gray-200 animate-scale-in">
                      <div className="py-2">
        ...
        <main className='w-full min-h-screen flex items-center justify-center pt-24'>
          <StaggeredAnimation animationType="scale" staggerDelay={150}>
            <div className='flex gap-2 justify-center items-center'>
              {/* CREATE - Blue outlined candlesticks */}
              <div className='flex gap-2 items-end'>
                {['C', 'R', 'E', 'A', 'T', 'E'].map((letter, index) => (
                  <div key={letter} className='flex flex-col items-center'>
                    <div className={`bg-white border-4 border-blue-500 w-16 h-${20 + index * 2} flex justify-center items-center shadow-2xl rounded-t-2xl transform hover:scale-110 transition-transform duration-300 hover-lift`}>
                      <span className='text-blue-500 font-bold text-4xl'>{letter}</span>
                    </div>
              ...
              <div className='flex gap-2 items-end'>
                {['I', 'N', 'V', 'E', 'S', 'T', '/', 'C', 'R', 'O', 'W', 'D', 'F', 'U', 'N', 'D'].map((letter, index) => (
                  <div key={letter} className='flex flex-col items-center'>
                    <div className={`bg-gray-800 w-16 h-${16 + (index % 4) * 2} flex justify-center items-center shadow-2xl rounded-t-2xl transform hover:scale-110 transition-transform duration-300 hover-lift`}>
                      <span className='text-blue-500 font-bold text-4xl'>{letter}</span>
                    </div>
        ...
        {/* Tagline */}
        <EnhancedScrollAnimations animationType="slideUp" delay={500}>
          <div className='absolute bottom-8 left-8 max-w-2xl'>
            <div className='bg-white/90 backdrop-blur-md rounded-3xl px-8 py-6 border border-gray-200 shadow-2xl hover-lift'>
      ...
      <div ref={page2Ref} className="min-h-screen w-full py-16 bg-white">
        <div className='max-w-7xl mx-auto px-8'>
          <EnhancedScrollAnimations animationType="slideUp">
            <div className='text-center mb-16'>
              <h2 className='text-6xl font-bold text-gray-800 mb-4 underline decoration-2 decoration-gray-600'>
                Fresh Favorites
              </h2>
              <div className='flex justify-center space-x-4 mt-6'>
                <button className='w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gray-700 transition-colors duration-200 hover-lift'>
          ...
          <StaggeredAnimation animationType="slideUp" staggerDelay={200}>
            <div className='flex space-x-6 overflow-x-auto pb-8'>
              {/* Project Cards */}
              {[1, 2, 3].map((card) => (
                <div key={card} className='min-w-80 bg-white border-2 border-blue-500 rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-transform duration-300 hover-lift'>
                  <div className='relative'>
                    <img src={`https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=400&h=300&fit=crop&v=${card}`} alt="Project" className='w-full h-48 object-cover' />
                    <div className='absolute top-4 left-4'>
                      <div className='w-10 h-10 bg-blue-500 rounded-full flex items-center justify-center hover-lift'>
                  ...
                  <div className='p-6'>
                    <div className='flex justify-between items-start mb-4'>
                      <div>
                        <h3 className='text-xl font-bold text-gray-800 mb-2'>Project {card}</h3>
                        ...
                        <div className='text-blue-600 font-semibold'>{60 + card * 15}% Funded</div>
                      </div>
        ...
        <div className='max-w-7xl mx-auto px-8'>
          ...
          <StaggeredAnimation animationType="scale" staggerDelay={150}>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
              {/* Creator Cards */}
              {[
                { name: 'Engineer', img: 'photo-1507003211169-0a1dd7228f2d' },
                { name: 'Finance Pro', img: 'photo-1551434678-e076c223a692' },
                { name: 'Designer', img: 'photo-1494790108755-2616b612b786' },
                { name: 'Analyst', img: 'photo-1551288049-bebda4e38f71' }
              ].map((creator, index) => (
                <div key={index} className='bg-white border-2 border-blue-500 rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-transform duration-300 hover-lift'>
                  <img src={`https://images.unsplash.com/${creator.img}?w=400&h=300&fit=crop`} alt={creator.name} className='w-full h-48 object-cover' />
                  <div className='p-6'>
      ...
      <div className="min-h-screen w-full py-16 bg-white">
        <div className='max-w-7xl mx-auto px-8'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-16'>
            ...
            <EnhancedScrollAnimations animationType="slideLeft">
              <div className='relative'>
                  ...
                  <StaggeredAnimation animationType="slideUp" staggerDelay={200}>
                    <div className='space-y-8'>
                      <div className='flex items-center space-x-6'>
                        <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=200&h=150&fit=crop" alt="Teamwork" className='w-48 h-32 object-cover rounded-lg border-2 border-gray-300 hover-lift' />
            ...
            <EnhancedScrollAnimations animationType="slideRight">
              <div className='relative'>
                <h3 className='text-4xl font-bold text-gray-800 mb-8 underline decoration-2 decoration-gray-600'>
                  Fund A Project
                </h3>
