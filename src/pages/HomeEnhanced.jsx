          ...
          <div className='flex gap-2 justify-center items-center'>
            ...
            <div className='flex gap-2 items-end'>
              {['C', 'R', 'E', 'A', 'T', 'E'].map((letter, index) => (
                <div key={letter} className='flex flex-col items-center'>
                  <div className={`bg-white border-4 border-blue-500 w-16 h-${20 + index * 2} flex justify-center items-center shadow-2xl rounded-t-2xl transform hover:scale-110 transition-transform duration-300`}>
            ...
            <div className='flex gap-2 items-end'>
              {['I', 'N', 'V', 'E', 'S', 'T', '/', 'C', 'R', 'O', 'W', 'D', 'F', 'U', 'N', 'D'].map((letter, index) => (
                <div key={letter} className='flex flex-col items-center'>
                  <div className={`bg-gray-800 w-16 h-${16 + (index % 4) * 2} flex justify-center items-center shadow-2xl rounded-t-2xl transform hover:scale-110 transition-transform duration-300`}>
                    <span className='text-blue-500 font-bold text-4xl'>{letter}</span>
                  </div>
      ...
      <div ref={page2Ref} className="min-h-screen w-full py-16 bg-white">
        <div className='max-w-7xl mx-auto px-8'>
          ...
          <div className='flex space-x-6 overflow-x-auto pb-8'>
            {/* Project Cards */}
            {[1, 2, 3].map((card) => (
              <div key={card} className='min-w-80 bg-white border-2 border-blue-500 rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-transform duration-300'>
                <div className='relative'>
        ...
        <div className='max-w-7xl mx-auto px-8'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
            ...
            {[
              ...
              <div key={index} className='bg-white border-2 border-blue-500 rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-transform duration-300'>
